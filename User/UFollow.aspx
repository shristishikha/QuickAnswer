<%@ Page Title="" Language="C#" MasterPageFile="~/User/Welcome.master" AutoEventWireup="true" CodeFile="UFollow.aspx.cs" Inherits="User_UFollow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td colspan = "4">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:LinkButton ID="lbtnUFollow" runat="server" onclick="lbtnUFollow_Click"><b>Unfollow</b></asp:LinkButton>
        ...
        <div id = "Nothing" runat = "server" style = "margin:250px 0 0 320px">
            <asp:Label ID="lblNtng" runat="server" Font-Size = "24px" Text=".....No favorite question added....."></asp:Label>
        </div>
