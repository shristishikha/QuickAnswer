<%@ Page Title="" Language="C#" MasterPageFile="~/User/Welcome.master" AutoEventWireup="true" CodeFile="WSearch.aspx.cs" Inherits="User_WSearch" %>
...
<br />
                    ...
                    <td colspan = "4">
                        ...
                        <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                            ...
                            <asp:Repeater ID="rptOrders" runat="server">
                                ...
                                <%--Answer Repeater--%>
                                <HeaderTemplate>
                                    <div style = "margin:-10px 0 0 -713px;">
        ...
        <div style = "width:100%;height:25px;margin:-3% 0 0 0;background:rgb(212,219,229);"></div>
