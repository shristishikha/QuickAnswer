<%@ Page Title="" Language="C#" MasterPageFile="~/User/Welcome.master" AutoEventWireup="true" CodeFile="uqun.aspx.cs" Inherits="User_uqun" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <div style = "margin:0 2% 0 5%;width:825px;background:white;">
    ...
    <%--Question Repeater--%>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td colspan = "4">
                        ...
                        <asp:HyperLink ID="HyperLink1" NavigateUrl='<%#Eval("Q_id","~/User/uqun.aspx?UID={0}") %>' runat="server"><b>Delete</b></asp:HyperLink>
        ...
        <div id = "Nothing" runat = "server" style = "margin:250px 0 0 320px">
            <asp:Label ID="lblNtng" runat="server" Font-Size = "24px" Text=".....You haven't answered any question yet....."></asp:Label>
        </div>
